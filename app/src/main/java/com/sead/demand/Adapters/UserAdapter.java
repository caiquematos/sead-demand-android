...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder>{
    ...
    public UserAdapter(List<User> userList, Context context) {
        ...
        this.mCurrentUser = CommonUtils.getCurrentUserPreference(context);
    }
    ...
    public class StatusTask extends AsyncTask<Void, Void, String> {
        ...
        private int superiorId; // current logged user id.
        ...
        public StatusTask(int id, String status, ViewHolder holder, int position) {
            ...
            this.superiorId = mCurrentUser.getId();
        }
        ...
        protected String doInBackground(Void... params) {
            ...
            values.put("superior", superiorId);
            values.put("user", id);
